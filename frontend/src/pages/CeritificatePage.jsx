  ...
  const drawCertificate = (courseCode, isPreview = false) => {
    return new Promise((resolve, reject) => {
      ...
      image.onload = async () => {
        ...
        context?.fillText(name, 350, 915)

        context.font = 'bold 40px Arial'
        context.fillStyle = 'red'
        context?.fillText(course, 985, 990)

        context.font = 'bold 35px Arial'
        context.fillStyle = 'black'
        context?.fillText(`${date}`, 410, 1057)

        context.font = 'bold 40px Arial'
        context.fillStyle = 'black'
        context?.fillText(courseCode, 1500, 33)
        ...
        context?.drawImage(qrCanvas, canvas.width - 1610, canvas.height - 340)
